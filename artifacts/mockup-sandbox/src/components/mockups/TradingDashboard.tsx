      ...
      <div className="flex items-center gap-3 px-4 py-2 bg-[#0f172a] border-b border-slate-700/50 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-slate-500">10-AGENT · CALL/PUT · REAL-TIME</div>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-slate-800 shrink-0 bg-[#0c1322]">
        ...
        {judgment?.horizon && (
          <span className="ml-auto text-[10px] text-slate-500 italic shrink-0">
            current: {judgment.horizon.label} · need {judgment.horizon.threshold}/10 agents
          </span>
        )}
      </div>
          ...
          {votes.length > 0 && (
            <div className="px-3 py-2 bg-[#0d1524] border-t border-slate-800 shrink-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs text-slate-500">{votes.length}/10 agents voted</span>
              ...
              <div className="space-y-4">
                {!judgment && !analyzing ? (
                  <div className="text-center py-8 space-y-2">
                    ...
                    <p className="text-slate-500 text-xs">10 agents will vote CALL / PUT / HOLD</p>
                    <p className="text-slate-600 text-xs">6 of 10 must agree to fire a signal</p>
                  </div>
                ) : analyzing ? (
